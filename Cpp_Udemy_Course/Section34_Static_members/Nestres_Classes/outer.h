...
public:
    ...
    void do_something(){
        Inner inner1(10.0);
        //Outer doesn't have access to private parts of inner has to 
...
private:
    ...
    public:
        ...
        double get_double() const{
            //Accesing private parts of Outer
            //std::cout << "Inner accessing m_var1 : " << m_var1 << std::endl;// Compile error
